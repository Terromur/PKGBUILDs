...
- Когда создаёте offline аккаунт, то при запуске Майнкрафта, вылезет окно, что у вас нет аккаунтов. Нажимаете "Да" и закрываете появившиеся окно - можете играть!

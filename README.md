...
- Добавление патчей на совместимость сборки модулей DKMS через clang+lto, а так же добавление polly флагов
- Добавление патча на улучшение синхронизации кадров для gamescope и не только
- Патч на оптимизацию rt
- Набор патчей Clear Linux
